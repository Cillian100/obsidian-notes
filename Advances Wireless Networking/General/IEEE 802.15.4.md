- A technical standard that defines the operation of a low rate [[Wireless PAN]].
	- it specifies he physical layer and the media access control
- The IEEE 802.15.4 MAC specifies two MAC modes
	1. non-beacon-enabled
	2. beacon-enabled
